...
/** Command represents an com.totsp.home.friday.x10 command.  This class encapsulates
...
* X10Interface to have the command executed.<BR><BR>
*
...
public class Command implements Serializable
{
    ...
    /** ALL_UNITS_OFF byte - the com.totsp.home.friday.x10 function "All Units Off".
    * This function turns all com.totsp.home.friday.x10 units off.
    *
    * @serial
    */
    ...
    /** ALL_LIGHTS_ON byte - the com.totsp.home.friday.x10 function "All Lights On".
    * This function turns all com.totsp.home.friday.x10 light modules on.
    *
    * @serial
    */
    ...
    /** ON byte - the com.totsp.home.friday.x10 function "On".
    ...
    */
    ...
    /** OFF byte - the com.totsp.home.friday.x10 function "Off".
    ...
    */
    ...
    /** DIM byte - the com.totsp.home.friday.x10 function "Dim".
    ...
    */
    ...
    /** BRIGHT byte - the com.totsp.home.friday.x10 function "Bright".
    ...
    */
    ...
    /** ALL_LIGHTS_OFF byte - the com.totsp.home.friday.x10 function "All Lights Off".
    * This function turns all com.totsp.home.friday.x10 light modules off.
    *
    * @serial
    */
    ...
    * X10Interface.  It is recommended that instances of this class be
    * constructed with one of the String-parameter-based constructors.
    *
    * @param address an com.totsp.home.friday.x10 module's housecode and unitcode in
    * "CM11A" protocol format.
    * @param function an com.totsp.home.friday.x10 function in "CM11A" protocol
    * format.
    *
    */
    ...
    * a X10Interface.  It is recommended that instances of this class be
    * constructed with one of the String-parameter-based constructors.
    *
    * @param address an com.totsp.home.friday.x10 module's housecode and unitcode in
    * "CM11A" protocol format.
    * @param function an com.totsp.home.friday.x10 function in "CM11A" protocol
    * format.
    * @param level an com.totsp.home.friday.x10 module level in "CM11A" protocol
    * format.
    *
    */
    ...
    * @return boolean - true if the address is a valid com.totsp.home.friday.x10 address, false otherwise
    *
    */
    ...
    */
    ...
    /** getAddress returns the com.totsp.home.friday.x10 address in ready-to-send "CM11A" protocol format.
    *
    * @return short - the com.totsp.home.friday.x10 address in "CM11A" protocol format.
    *
    */
    ...
    /** getFunction returns the com.totsp.home.friday.x10 function in ready-to-send "CM11A" protocol format.
    *
    * @return short - the com.totsp.home.friday.x10 function in "CM11A" protocol format.
    *
    */
    ...
    */
    ...
    /** getAddress returns a String-based com.totsp.home.friday.x10 address as a
    * [HouseCode][UnitCode] two-character String, based on the
    * specified address in com.totsp.home.friday.x10 "CM11A" protocol format.
    *
    * @param address the com.totsp.home.friday.x10 address as a "CM11A" protocol value.
    * @return String - the com.totsp.home.friday.x10 addres as a two-character [Housecode][Unitcode]
    * address (ie "G5").
    *
    */
    ...
    * based on the specified function in com.totsp.home.friday.x10 "CM11A" protocol format.
    *
    * @param function the com.totsp.home.friday.x10 function as a "CM11A" protocol value.
    * @return byte - the com.totsp.home.friday.x10 function as a constant (see above).
    *
    */
