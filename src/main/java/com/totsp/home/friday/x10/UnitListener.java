...
* by software-based com.totsp.home.friday.x10 modules.  A registered UnitListener will
...
public interface UnitListener
{
    ...
    /** allUnitsOff is called when an com.totsp.home.friday.x10 All Units Off event occurs.
    *
    ...
    */
    ...
    /** allLightsOff is called when an com.totsp.home.friday.x10 All Lights Off event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
    ...
    /** allLightsOn is called when an com.totsp.home.friday.x10 All Lights On event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
    ...
    /** unitOn is called when an com.totsp.home.friday.x10 On event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
    ...
    /** unitOff is called when an com.totsp.home.friday.x10 Off event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
    ...
    /** unitDim is called when an com.totsp.home.friday.x10 Dim event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
    ...
    /** unitBright is called when an com.totsp.home.friday.x10 Bright event occurs.
    *
    * @param event the UnitEvent that is dispatched.
    *
    */
